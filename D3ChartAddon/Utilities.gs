var LOG_ON = false;
var LOG_SPREADSHEET_KEY = '1JKObmAugdSkmhU0S6PuU9DBAtVCEb_IymPEUmzif4Hk';
...
/**
 * Log passed values to a spreadsheet since HtmlService doesn't play well with Log.logger
 * @param {string} logString Information to log
 */
